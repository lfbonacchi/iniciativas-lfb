...
const users: User[] = [
  ...
  },
  {
    ...
    job_title: "VP Downstream",
    department: "Dirección Downstream",
    vicepresidencia: "VP Downstream",
    global_role: "user",
    is_vp: true,
  },
  ...
  mkResp(ini001_F1.id, "seccion_9_equipo", {
    ...
    gate_1: [
      ...
      },
      {
        ...
        posicion: "VP Downstream",
        area: "Dirección Downstream",
      },
    ],
    metodologia: [
      {
...
const ini006_F4_2025_responses: FormResponse[] = [
  ...
  mkResp(ini006_F4_2025.id, "necesidad_oportunidad", [
    ...
    {
      stakeholder: "Sponsor (VP Downstream)",
...
const ini008_F4_2026_responses: FormResponse[] = [
  mkResp(ini008_F4_2026.id, "info_general", {
    ...
    areas_involucradas:
      "Dirección Upstream, Dirección Downstream, Supply Chain, Seguridad, Sustentabilidad",
    tipo: "Habilitadora",
  }),
  mkResp(
    ini008_F4_2026.id,
  ...
  mkResp(ini008_F4_2026.id, "necesidad_oportunidad", [
    ...
    {
      stakeholder: "Usuario (VP Downstream)",
