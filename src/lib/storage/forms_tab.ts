...
const SECTIONS: Record<FormType, SectionDef[]> = {
  ...
  F3: [
    { number: 1, title: "Información general" },
    { number: 2, title: "Descripción del MVP" },
    { number: 3, title: "Indicadores de medición" },
    { number: 4, title: "Resultados esperados vs obtenidos" },
    { number: 5, title: "Aprendizajes y bloqueantes" },
    { number: 6, title: "Conclusiones del MVP" },
    { number: 7, title: "Journey y próximos pasos" },
    { number: 8, title: "Equipo Execute & Operate" },
    { number: 9, title: "Consideraciones digitales" },
    { number: 10, title: "Plan de gestión del cambio" },
  ],
  F4: [
    { number: 1, title: "Información general" },
    { number: 2, title: "Propósito y necesidad" },
    { number: 3, title: "Prioridades estratégicas del año" },
    { number: 4, title: "Descripción y entregables del año" },
    { number: 5, title: "Planificación de la implementación" },
    { number: 6, title: "Costos e impacto económico" },
  ],
  F5: [
    { number: 1, title: "Información general" },
    { number: 2, title: "Entregables del año" },
    { number: 3, title: "Indicadores de seguimiento" },
    { number: 4, title: "Plan de acción" },
    { number: 5, title: "Riesgos y dependencias" },
  ],
};
